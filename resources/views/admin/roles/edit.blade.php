	  ...
	  <div class="mt-5 md:mt-0 md:col-span-2">
        ...
        <div class="shadow overflow-hidden sm:rounded-md">
          ...
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                ...
                <div class="flex-col py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            @foreach ($permisos as $value)
                                
                            <label>
                              {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rol_permisos) ? true : false, array('class' => 'name')) }}
                                {{ $value->name }}</label>
