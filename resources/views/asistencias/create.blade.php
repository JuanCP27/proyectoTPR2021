...
<div class="mt-10 sm:mt-0">
	<div class="md:grid md:grid-cols-3 md:gap-6">
	  ...
	  <div class="mt-5 md:mt-0 md:col-span-2">
		...
		<form action="{{route('asistencias.create')}}" method="POST" enctype="multipart/form-data">
            @csrf
			...
			<div class="px-4 py-5 bg-white sm:p-6">
			  <div class="grid grid-cols-6 gap-6">
				...
				<div class="col-span-6 sm:col-span-3">
					<label for="rol" class="block text-sm font-medium text-gray-700">Fecha:</label>
				  <input  type="datetime-local" value="" input="datetime-local" name="fecha_registro" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md required">				  
				 
				</div>
				<div class="col-span-6 sm:col-span-3">
					<label for="rol" class="block text-sm font-medium text-gray-700">Profesor:</label>
				  <input  type="text" value="{{$user->id}}" input="datetime-local" name="fecha_registro" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md required">				  
				...
				<div class="col-span-6 sm:col-span-6 lg:col-span-2">
				  ...
				  <input type="text" value="1" readonly name="estado"  class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
				</div>
